...
@section('content')
    ...
    <section class="ass3ageSection2">
        <div class="container text-uppercase py-5" style="text-align: center;">
            ...
            <h3>Programme de Coaching pour les Couples</h3>
            ...
            <div class="d-flex justify-content-center align-item-center" class="background: inherit !important;">
                <img class="img-fluid my-5" style="height: 75vh; width: 85%;" src="/assets/img/cc.jpg">
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-lg-7 col-10 m-auto">
                    <div class="content">
                        ...
                        <h4 id="what-is-the-main-mission-of-mine-and-what-i-wanna-do" class="mt-4"
