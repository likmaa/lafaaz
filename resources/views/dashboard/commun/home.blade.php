	...
	<div class="col-lg-12 d-flex align-items-stretch">
		<div class="card w-100">
			<div class="card-body p-4">
				<div class="mb-4">
					<h5 class="card-title fw-semibold text-center">Les dernières actualités</h5>
				</div>
				<div class="row">
...
<div class="row">
	<div class="col-lg-12 d-flex align-items-stretch">
		<div class="card w-100">
			<div class="card-body p-4">
				<h5 class="card-title fw-semibold mb-4">Inscriptions récents</h5>
							...
							<tr>
								...
								<td class="border-bottom-0">
									<div class="d-flex align-items-center gap-2">
										<p class="mb-0 fw-normal">{{$user->contact}}</p>
									</div>
								</td>
								<td class="border-bottom-0">
									<h6 class="fw-semibold mb-0 fs-4">{{$user->profession}}</h6>
								</td>
							</tr>
							@endforeach
						</tbody>
		...
		<div class="card w-100">
			<div class="card-body p-4">
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="card">
							<img src="{{ config('filesystems.disks.public.url') . $realisation->image}}" height="175" class="card-img-top" alt="...">
							<div class="card-body">
