...
@section('content')
    ...
    <div class="modal fade" id="editprofilModal{{ Auth::user()->id }}" id="exampleModal" tabindex="-1"
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="email" class="form-control" name="email"
                                    placeholder="Ex: johndoe@gmail.com" aria-label="Email">
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="">Contact</label>
                                <input type="text" class="form-control" name="contact"
                                    placeholder="Ex: 00229 60000000" aria-label="Contact">
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="">Adresse</label>
                                <input type="text" class="form-control" name="adresse"
                                    placeholder="Ex: Maison YAYIVI" aria-label="Adresse">
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="">Ville</label>
                                <input type="text" class="form-control" name="ville"
                                    placeholder="Ex: Abomey-Calavi" aria-label="Ville">
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="">Pays</label>
                                <input type="text" class="form-control" name="pays" placeholder="Ex: Bénin"
                                    aria-label="Pays">
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="">Profession</label>
                                <input type="text" class="form-control" name="profession" placeholder="Ex: Designer"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="lieu" placeholder="Ex: Sekandji"
