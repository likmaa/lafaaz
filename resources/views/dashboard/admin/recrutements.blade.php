					...
					<table class="table mb-0 text-left">
						...
						<tbody>
							...
							<tr>
								...
								<td class="cell">
									<a class="btn-sm app-btn-secondary" href="{{route('dstage', $stage->id)}}">Voir</a>
									<a class="btn-sm app-btn-secondary" href="{{route('Destroyrecrute', $stage->id)}}">Supprimer</a>
								</td>
							</tr>
							@endforeach
						</tbody>
						...
						<tbody>
							...
							<tr>
								...
								<td class="cell">
									...
									<a class="btn-sm app-btn-secondary" href="{{route('Destroyrecrute', $emploie->id)}}">Supprimer</a>
				...
				<div class="modal-body px-4">
					...
					<div class="row my-4">
						<div class="col-lg-12 mb-3">
							...
							<textarea name="description" id="description" cols="30" placeholder="Descriptio de l'offre" class="form-control" rows="5"></textarea>
						</div>
					</div>
				</div>
