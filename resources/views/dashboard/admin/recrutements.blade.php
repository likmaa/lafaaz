...
@section('content')
        ...
        <div class="col-auto">
            <div class="page-utilities">
                <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                    ...
                    <div class="col-auto">
                        <button type="submit" class="btn app-btn-secondary" data-bs-toggle="modal"
    ...
    <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
        <a class="flex-sm-fill text-sm-center nav-link active" id="orders-paid-tab" data-bs-toggle="tab" href="#orders-paid"
            role="tab" aria-controls="orders-paid" aria-selected="true"> Offres de stage</a>
        <a class="flex-sm-fill text-sm-center nav-link" id="orders-pending-tab" data-bs-toggle="tab" href="#orders-pending"
            role="tab" aria-controls="orders-pending" aria-selected="false">Offres d'emplois</a>
        <a class="flex-sm-fill text-sm-center nav-link" id="orders-cancelled-tab" data-bs-toggle="tab"
            href="#orders-cancelled" role="tab" aria-controls="orders-cancelled" aria-selected="false">Bénévolats</a>
    </nav>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell">
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('dstage', $stage->id) }}">Voir</a>
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('afficherModificationOffre', $stage->id) }}">Modifier</a>
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('Destroyrecrute', $stage->id) }}">Supprimer</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                            ...
                            <tbody>
                                @foreach ($emploies as $emploie)
                                    <tr>
                                        ...
                                        <td class="cell">
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('demplois', $emploie->id) }}">Voir</a>
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('afficherModificationOffre', $emploie->id) }}">Modifier</a>
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('Destroyrecrute', $emploie->id) }}">Supprimer</a>
                ...
                <div class="app-card-body">
                    @if ($errors->any())
                        <div class="alert alert-danger">
							...
							<p><i>Renseignez à nouveau les Informations</i></p>
                        </div>
                    @endif
                    <div class="table-responsive">
                        <table class="table mb-0 text-left">
                            ...
                            <tbody>
                                @foreach ($benevolats as $benevolat)
                                    <tr>
                                        ...
                                        <td class="cell">
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('dbenevol', $benevolat->id) }}">Voir</a>
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('afficherModificationOffre', $benevolat->id) }}">Modifier</a>
                                            <a class="btn-sm app-btn-secondary"
                                                href="{{ route('Destroyrecrute', $benevolat->id) }}">Supprimer</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('addrecrutement') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body px-4">
                        ...
                        <div class="row my-4">
                            @php
                                $reference = \Illuminate\Support\Str::random(8);
                            @endphp
                            <div class="col-lg-6 mb-3">
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 mb-3">
                                ...
                                <textarea name="description" id="description" cols="30" placeholder="Descriptio de l'offre"
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="item-data">
                                        Cliquer
                                        <b><a href="http://" target="_blank" rel="noopener noreferrer">ici</a></b> pour
