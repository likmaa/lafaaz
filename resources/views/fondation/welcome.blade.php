...
@section('content')
                ...
                @foreach ($projets as $projet)
                    <div class="gallery-cell">
                        ...
                        <div class="content mt-3 py-3 px-3 mx-3">
                            ...
                            @php
                                $extraitDescription = substr($projet->description, 0, 100);
                            @endphp
                            <p>{{ $extraitDescription }}...</p>
                            <div class="offset-lg-10 col-lg-1 me-4">
                                <a href="{{ route('detail', $projet->id) }}"><button class="px-4 py-2">Détail</button></a>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <section id="featured-services" class="featured-services">
        <div class="container homeSection6" data-aos="fade-up">
            <h2 class="fw-500">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="49" viewBox="0 0 68 68"
                    fill="none">
                    <path
                        d="M30.2222 28.3205C30.2222 31.4487 27.6852 33.9846 24.5556 33.9846C21.4259 33.9846 18.8889 31.4487 18.8889 28.3205C18.8889 25.1923 21.4259 22.6564 24.5556 22.6564C27.6852 22.6564 30.2222 25.1923 30.2222 28.3205Z"
                        fill="url(#paint0_linear_1_886)" />
                    <path
                        d="M49.1111 28.3205C49.1111 31.4487 46.5741 33.9846 43.4444 33.9846C40.3148 33.9846 37.7778 31.4487 37.7778 28.3205C37.7778 25.1923 40.3148 22.6564 43.4444 22.6564C46.5741 22.6564 49.1111 25.1923 49.1111 28.3205Z"
                        fill="url(#paint1_linear_1_886)" />
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M0 16.9923V50.9769C0 64.9793 15.993 72.9721 27.2 64.5707L37.7778 56.641H51C60.3888 56.641 68 49.0333 68 39.6487V16.9923C68 7.60771 60.3888 0 51 0H17C7.61116 0 0 7.60771 0 16.9923ZM11.3333 16.9923V50.9769C11.3333 55.6443 16.6643 58.3086 20.4 55.5081L32.4889 46.4456C33.4698 45.7103 34.6628 45.3128 35.8889 45.3128H51C54.1296 45.3128 56.6667 42.7769 56.6667 39.6487V16.9923C56.6667 13.8641 54.1296 11.3282 51 11.3282H17C13.8704 11.3282 11.3333 13.8641 11.3333 16.9923Z"
                        fill="url(#paint2_linear_1_886)" />
                    <defs>
                        <linearGradient id="paint0_linear_1_886" x1="34" y1="0" x2="34"
                            y2="68" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#0E7ABE" />
                            <stop offset="1" stop-color="#01B044" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_1_886" x1="34" y1="0" x2="34"
                            y2="68" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#0E7ABE" />
                            <stop offset="1" stop-color="#01B044" />
                        </linearGradient>
                        <linearGradient id="paint2_linear_1_886" x1="34" y1="0" x2="34"
                            y2="68" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#0E7ABE" />
                            <stop offset="1" stop-color="#01B044" />
                        </linearGradient>
