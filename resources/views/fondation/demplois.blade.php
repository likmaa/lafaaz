    ...
    <div class="container">
            ...
            <div class="col-lg-12 my-3">
                <div class="card mb-3 bg-white py-4">
                    <div class="row g-0 px-3">
                        <h3 class="card-title text-body-secondary text-center">{{$emploie->titre}}</h3>
                        <div class="col-md-10">
                            <div class="card-body py-2">
                                <p class="card-text">
                                    <small class="text-body-secondary py-5"><i class="bi bi-briefcase-fill px-1"></i>Expérience: {{$emploie->experience}}ans</small>
                                    <br><small class="text-body-secondary py-5"><i class="bi bi-mortarboard-fill px-1"></i>Etudes: {{$emploie->niveaue}}</small>
                                    <br><small class="text-body-secondary py-5"><i class="bi bi-calendar px-1"></i>Contrat: {{$emploie->contrat}}</small>
                                    <br><small class="text-body-secondary py-5"><i class="bi bi-alarm-fill px-1"></i>Publié le: {{$emploie->created_at}}</small>
                                    <br><small class="text-body-secondary py-5"><i class="bi bi-alarm-fill px-1"></i>Expire le: {{$emploie->expire}}</small>
                                </p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card mb-3 bg-white p-2">
                            <div class="card-body">
                                <h5 class="card-title text-body-secondary">{{$emploie->titre}}</h5>
                                <p class="card-text pt-2 lead">
                                    Référence: <small class="text-body-secondary text-bold-500">{{$emploie->reference}}</small>
                                </p>
                                <p class="card-text pt-2 lead">
                                    Date limite de candidature : {{$emploie->expire}}
                                </p>
        ...
        <div class="row mt-5">
            <div class="col-lg-12">
                ...
                <p class="justify-content-center align-items-center text-center">
                    <button class="mt-4 px-5 py-2 justify-content-center"><a href="{{route('emplois')}}">Voir plus d'offres</a></button>
